package dev.ved.kranklink.doctor_service.service;


import dev.ved.kranklink.doctor_service.entity.Doctor;
import dev.ved.kranklink.doctor_service.enums.consultationType;
import dev.ved.kranklink.doctor_service.repository.DoctorRepository;
...
public class DoctorService {
    ...
    public Doctor updateDoctor(String id, Doctor updatedDoctor) {
        ...
        if (optionalDoctor.isPresent()) {
            ...
            doctor.setConsultationType(updatedDoctor.getConsultationType());
